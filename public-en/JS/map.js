...
// map.addControl(new MapboxBrowserLanguage({ defaultLanguage: "en" }));
...
map.on("load", function() {
  ...
  map.on("click", "countries-layer", function(e) {
    ...
    addMarker(e);
    updateLabels(e.features[0].properties.name, e.features[0].properties.name);
  });
...
fetch("https://corona.lmao.ninja/all")
  ...
  .then(function(data) {
    ...
    countryDiv.innerHTML = "World wide";
    ...
    casesDiv.innerHTML = "Cases : " + String(data["cases"]);
    ...
    rDiv.id = "recovered";
    rDiv.className = "tags";
    rDiv.innerHTML = "Recovered : " + String(data["recovered"]);
    ...
    dDiv.id = "deaths";
    dDiv.className = "tags";
    dDiv.innerHTML = "Deaths : " + String(data["deaths"]);
...
function updateLabels(country, country_in_arabic) {
  ...
  if (data == undefined) {
    document.getElementById("cases").innerHTML = "Cases : " + "unknown";
    document.getElementById("recovered").innerHTML = "Recovered : " + "unknown";
    document.getElementById("deaths").innerHTML = "Deaths : " + "unknown";
    document.getElementById("todayCases").innerHTML =
      "Today's cases: " + "unknown";
    document.getElementById("todayDeaths").innerHTML =
      "Today's deaths: " + "unknown";
    document.getElementById("critical").innerHTML =
      "Critical cases: " + "unknown";
  ...
  document.getElementById("critical").innerHTML = "Critical cases: " + critical;
  document.getElementById("cases").innerHTML = "Cases : " + cases;
  document.getElementById("recovered").innerHTML = "Recovered : " + recovered;
  document.getElementById("deaths").innerHTML = "Deaths : " + dead;
}
